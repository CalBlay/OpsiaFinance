    ...
    <div className={styles.page}>
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Mapeig del text de la fila 2 del balanç (A2) cap a un centre de l&apos;arbre. En importar
          amb el tipus «Balanç esdeveniments (ajustos)», es creen ajustos amb motiu Regularització
          només amb línies de detall (sense subtotals).
        </p>
      </header>
